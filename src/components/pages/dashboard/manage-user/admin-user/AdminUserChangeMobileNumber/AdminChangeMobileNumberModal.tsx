...
function AdminChangeMobileNumberModal(
  {
    open, onClose, formMethods, onSubmit, loading, mobileNumberNotVerifiedMessage, onCloseMobileNumberNotVerified,
    onConfirmChangingMobileNumberWhenNotVerified, modalShouldBeRemoved,
  ...
  return (
    <>
      ...
      {!mobileNumberNotVerifiedMessageModalShouldBeRemoved && (
        <Modal
          open={Boolean(mobileNumberNotVerifiedMessage)} onClose={onCloseMobileNumberNotVerified}
          title='تغییر شماره همراه کاربر'
        >
          <ModalDescriptionText text={mobileNumberNotVerifiedMessage}/>
          <div className='grid grid-cols-2 gap-x-4'>
            <Button color='gray' onClick={onConfirmChangingMobileNumberWhenNotVerified} loading={loading}>
              تأیید
            </Button>
            <Button color='red' variant='outlined' onClick={onCloseMobileNumberNotVerified}>
              انصراف
            </Button>
          </div>
        </Modal>
...
export default AdminChangeMobileNumberModal